...
class rMD17(InMemoryDataset):
    ...
    def raw_file_names(self):
        # return osp.join(self.name , "data",self.mode + ".xyz")
        # return osp.join(self.name , "AT-AT-CG-CG", "data",self.mode + ".xyz")
        return osp.join(self.name , "Benzene", "data",self.mode + ".xyz")
